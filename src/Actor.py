...
class Actor():
    def __init__(self, n_actor_count):
        ...
        self.health_points = randint(50, 100)  # Start atleast at 50% of health
        self.strength = randint(1, 100)
        self.speed = randint(1, 100)
        self.location = [randint(0, 500), randint(0, 1000)]
    ...
    def keep_in(self):
        if self.location[0] > 1000:
            self.location[0] = 1000
        elif self.location[0] < 0:
            self.location[0] = 0
        if self.location[1] > 1000:
            self.location[1] = 1000
